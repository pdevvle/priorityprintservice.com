...
- `rocket_exclude_js` keeps WP Rocket's minifier off the extracted app script (its quote pairing loses sync on nested template literals); `pps-html-deploy.php` purges the page cache after every successful deploy.
